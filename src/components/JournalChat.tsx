  ...
  return (
    <div className="max-w-4xl mx-auto py-1 sm:py-2 px-2 sm:px-4 relative flex-1 flex flex-col min-h-0 h-full w-full overflow-hidden">
      ...
      <div className="bg-[#0E0E10] border border-[#1E1E20] rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden flex flex-col flex-1 min-h-0 h-full">
        ...
        <div className="px-3.5 sm:px-6 py-2.5 border-b border-[#1E1E20] bg-[#0A0A0B] flex items-center justify-between gap-3 shrink-0 min-h-[52px]">
          <div className="flex items-center space-x-2.5 min-w-0 flex-1">
            <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-[#4285F4] to-[#9B72F3] flex items-center justify-center text-white shadow-sm shrink-0">
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-wrap min-w-0">
              ...
              <span
                ...
                className="text-[#9E9EA5] flex items-center gap-1.5 text-[11px] sm:text-xs font-medium bg-[#161618] border border-[#2A2A2D] px-2 sm:px-2.5 py-1 rounded-lg shrink-0 shadow-xs"
          ...
          <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
            ...
            <button
              ...
              className="p-2 sm:px-2.5 sm:py-1.5 rounded-xl bg-[#161618] hover:bg-[#1E1E20] border border-[#2A2A2D] hover:border-[#4285F4] text-xs font-semibold text-[#E0E0E0] shadow-xs transition shrink-0 cursor-pointer flex items-center gap-1.5"
            ...
            <button
              ...
              onClick={onCancel}
              className="p-2 sm:px-2.5 sm:py-1.5 text-xs text-[#A0A0A0] hover:text-white bg-[#161618] hover:bg-[#1E1E20] border border-[#2A2A2D] rounded-xl transition shrink-0 cursor-pointer flex items-center gap-1.5 font-medium"
            ...
            <button
              ...
              className="p-2 sm:px-2.5 sm:py-1.5 text-xs text-[#808080] hover:text-[#F87171] bg-[#161618] hover:bg-[#F8717115] border border-[#2A2A2D] hover:border-[#F8717140] rounded-xl transition shrink-0 cursor-pointer flex items-center gap-1.5"
            ...
            <button
              ...
              className="p-2 sm:px-3 sm:py-1.5 bg-[#4285F4] hover:bg-[#3367D6] text-white rounded-xl text-xs font-bold shadow-sm transition disabled:opacity-50 shrink-0 cursor-pointer flex items-center gap-1.5"
        ...
        <div className="px-3.5 sm:px-6 py-2 bg-[#121214] border-b border-[#1E1E20] flex items-center justify-between gap-3 text-xs overflow-x-auto no-scrollbar shrink-0 min-h-[44px]">
          {/* Persona Selection */}
        ...
        {/* Messages Stream */}
        <div className="flex-1 overflow-y-auto p-3 sm:p-6 space-y-4 sm:space-y-6 bg-[#0E0E10]">
