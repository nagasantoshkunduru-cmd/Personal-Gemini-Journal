    ...
    <>
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/85 backdrop-blur-sm animate-in fade-in">
          <div className="bg-black border border-[#2A2A2D] rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4 text-center">
            <h3 className="text-base font-bold text-white [html[data-theme='light']_&]:text-neutral-900">Delete Journal Entry?</h3>
            <p className="text-xs text-[#A0A0A0] [html[data-theme='light']_&]:text-neutral-600 leading-relaxed">
            ...
            <div className="flex items-center justify-center gap-3 pt-2">
              <button
                ...
                disabled={isDeleting}
                className="px-4 py-2 text-xs font-medium text-[#E0E0E0] [html[data-theme='light']_&]:text-neutral-700 bg-[#2A2A2D] hover:bg-[#3A3A3D] border border-[#3A3A3D] rounded-xl transition cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                disabled={isDeleting}
                className="px-4 py-2 text-xs font-bold text-white bg-red-600 hover:bg-red-700 border border-red-700 rounded-xl transition cursor-pointer active:scale-95"
              >
